  ...
  return (
    <div className="screen with-nav home-screen">
      ...
      <section className="quick-grid">
        ...
        <button className="cake-tile" onClick={() => navigate('/cake?step=occasion')}><span className="cake-tile-kicker">Индивидуальный торт</span><strong>Оставить заявку</strong><small>Повод, оформление, дата и телефон</small><span className="cake-tile-arrow"><ArrowRight /></span></button>
      </section>
